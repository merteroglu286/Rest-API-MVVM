...
class FilterSProductAdapter(private val products: ArrayList<Product>,private val activity:Activity
) :
    RecyclerView.Adapter<FilterSProductAdapter.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.itemView.setOnClickListener{
            ...
            intent.putExtra("garageId",product.garageId)
            println(product.id)
