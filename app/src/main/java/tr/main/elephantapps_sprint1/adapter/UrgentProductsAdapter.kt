...
class UrgentProductsAdapter (private val products: ArrayList<UrgentProduct>,private val activity: Activity
) :
    RecyclerView.Adapter<UrgentProductsAdapter.ViewHolder>() {
